...
namespace PCS.UI
{
    ...
    public static class ScreenResolutionController
    {
        ...
        private static readonly Subject<Vector2Int> _onUpdateDeviceResolution = new Subject<Vector2Int>();
        public static IObservable<Vector2Int> OnUpdateDeviceResolution => _onUpdateDeviceResolution;
